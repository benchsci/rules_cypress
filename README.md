...
1. search for "aspect_rules_cypress" and replace with the name you'll use for your workspace
1. search for "aspect" and replace with GitHub org
1. search for "cypress" and replace with the language/tool your rules are for
1. rename directory "cypress" similarly
...
<https://github.com/aspect/rules_cypress/releases>
