...
CypressInfo = provider(
    ...
    fields = {
        "target_tool_path": "Path to the system installed cypress executable for the target platform.",
        "tool_files": """Files required in runfiles to make the cypress executable available.
